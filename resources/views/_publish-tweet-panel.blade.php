...
@if(\Illuminate\Support\Facades\Session::has('error'))
    <div class="p-2 bg-red-400 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex mb-4" role="alert">
        <span class="flex rounded-full bg-white uppercase px-2 py-1 text-xs font-bold mr-3 text-red-400">&#9432;</span>
        <span class="font-semibold mr-2 text-left flex-auto text-white">{{ \Illuminate\Support\Facades\Session::get('error') }}</span>
    </div>
@endif
